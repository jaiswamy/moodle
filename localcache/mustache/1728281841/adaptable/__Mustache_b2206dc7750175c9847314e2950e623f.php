...
class __Mustache_b2206dc7750175c9847314e2950e623f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block016d960a69aff870fe17864d7cae31b4'),
            ));
    ...
    private function sectionA9e841e9f36a31c1cdd50c4fb2eabb3d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9f6ba5e1c04b650bed5b8d37767526d0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block016d960a69aff870fe17864d7cae31b4($context)
    {
        $indent = $buffer = '';
...
';
        $value = $context->find('error');
        $buffer .= $this->sectionA9e841e9f36a31c1cdd50c4fb2eabb3d($context, $indent, $value);
        $value = $context->find('required');
        $buffer .= $this->section9f6ba5e1c04b650bed5b8d37767526d0($context, $indent, $value);
        $buffer .= $indent . '                            ';
...
';
        ...
        $buffer .= $indent . '                <a href="#" class="btn btn-link icon-no-margin p-1 ml-1" data-passwordunmask="unmask" title="';
