...
class __Mustache_c18df8f45b589fe09929ac432629e54a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA46a8672af5329aef664a44281223f37($context, $indent, $value);
        $value = $context->find('displayloginbox');
        if (empty($value)) {
...
';
    ...
    private function sectionA46a8672af5329aef664a44281223f37(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
